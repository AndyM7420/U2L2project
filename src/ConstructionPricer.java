public class ConstructionPricer
{
    ...
    public  double  costTotal(int Lumber, int Windows){
        double totalCost;
        totalCost = materialsCost(Lumber,Windows);
       double withTax = totalWithTax(totalCost);
       return withTax;
    }
    public double totalWithTax(int amountLumber, int needWindows){
        double totalCost;
        totalCost = materialsCost(amountLumber,needWindows);
        return totalCost;
    }
